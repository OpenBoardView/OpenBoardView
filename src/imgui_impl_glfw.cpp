...
bool ImGui_ImplGlfw_Init(GLFWwindow *window, bool install_callbacks) {
	...
	io.RenderDrawListsFn = ImGui_ImplGlfw_RenderDrawLists; // Alternatively you can set this to NULL
...
void ImGui_ImplGlfw_NewFrame() {
	...
	for (int i = 0; i < 3; i++) {
		io.MouseDown[i] = g_MousePressed[i] ||
		                  glfwGetMouseButton(g_Window, i) != 0; // If a mouse press event came,
