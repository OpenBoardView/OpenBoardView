...
part                : "PART" <s>+ <part_name_to_end> <n>;
...
device              : "DEVICE" <s>+ <part_name_to_end> <n> (<part>|<type>|<style>|<package>|<pindesc>|<pinfunct>|<pincount>|<value>|<tol>|<ntol>|<ptol>|<volts>|<desc>|<attribute>)* <n>*;
