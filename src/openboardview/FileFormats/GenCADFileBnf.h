...
included_in_device  : (/[^$D]/|/D[^E]/|/DE[^V]/|/DEV[^I]/|/DEVI[^C]/|/DEVIC[^E]/|/DEVICE\S/) <string_to_end> <n>+;
device              : "DEVICE" <s>+ <part_name_to_end> <n>+ (<part>|<type>|<style>|<package>|<pindesc>|<pinfunct>|<pincount>|<value>|<tol>|<ntol>|<ptol>|<volts>|<desc>|<attribute>|<partemp>|<included_in_device>)* <n>*;
