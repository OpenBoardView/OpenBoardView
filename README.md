...
For Ubuntu developers, you'll need the following packages at a minimum;
	...
	$ apt-get install git build-essential cmake libsdl2-dev libsdl2-image-dev libgtk-3-dev
...
For Fedora, you will need the following packages at a minimum;
	...
	$ dnf install SDL2-devel SDL2_image-devel gtk3-devel fontconfig-devel
